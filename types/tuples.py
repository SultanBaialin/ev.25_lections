...
# print('Turple:', b.__sizeof__())

# НЕизменяемый
# tuple_ = (1, 'h', 3)
# tuple_[1] = 2
# print(tuple_) don't work
...
# print(good_student)
# print(f'Ученики {",".join(good_student)} в этом семестре хорошо учатся!')
